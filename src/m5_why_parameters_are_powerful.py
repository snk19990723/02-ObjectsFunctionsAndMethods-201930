...
def main():
    ...
    even_better_draw_circles(rg.Point(100,50), 10, 1, 12, 'red', 5)
    window.update()
...
def even_better_draw_circles(point,radii,num1,num2,color,thickness):
    ...
    for k in range(num1, num2):  # k becomes 1, 2, 3, ... 10
